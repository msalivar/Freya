...
public class ExpandableListHandler
{
  ...
  //  public ArrayList<String> deletedChildren = new ArrayList<>();
    ...
    public ExpandableListHandler(Context c)
    {
       ...
       // listDataChild.put ("Deleted", deletedChildren);
    ...
    public void resetChildren()
    {
        ...
        unsyncedChildren = new ArrayList<>();
    ...
    public void addChild(String parentName, String childName) {
        switch (parentName)
        {
            case "Unsynced":
                ...
                break;
          /*  case "Deleted":
                if (!deletedChildren.contains(childName)) { deletedChildren.add(childName); }
                listDataChild.put(parentName, deletedChildren);*/
            //    break;
            case "People":
    ...
    public void removeChild(String parentName, String childName) {
        switch (parentName)
        {
            case "Unsynced":
                ...
                break;
//            case "Deleted":
//                while (deletedChildren.contains(childName))
//                {
//                    deletedChildren.remove(childName);
//                }
//                listDataChild.put(parentName, deletedChildren);
//                break;
            case "People":
