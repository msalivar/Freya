...
public class FileHandler
{
   ...
   static public void permCheck (){
    ...
    public static void GPSAccessPermission(Context cxt){
        int permissionCheck = ContextCompat.checkSelfPermission(cxt, Manifest.permission.ACCESS_FINE_LOCATION);

        if(permissionCheck != 0){
            ActivityCompat.requestPermissions((Activity) cxt, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},
                    1);
        }
    }
}
